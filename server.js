...
app.get("/api/scrape-stream/:theater", (req, res) => {
  ...
  const ALL_KEYS = ["grandAngle","mc2","vellein","hexagone","rampe","ilyade","ponsard","agora","diapason","theatreEnRond","heureBleue","faiencerie","manege","grenoble","summum","laussy","venceScene","atrium","morgado","tourDuPin","isleAbeau","jeanVilar","theatreSaintMartin","palaisSports"];
